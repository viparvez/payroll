...
<head>
  ...
  <link href="{{ url('/') }}/assets/vendor/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
...
<body class="bg-gradient-primary">
  ...
  <script src="{{ url('/') }}/assets/vendor/vendor/jquery/jquery.min.js"></script>
  <script src="{{ url('/') }}/assets/vendor/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

  <!-- Core plugin JavaScript-->
  <script src="{{ url('/') }}/assets/vendor/vendor/jquery-easing/jquery.easing.min.js"></script>

  <!-- Custom scripts for all pages-->
  <script src="{{ url('/') }}/assets/vendor/js/sb-admin-2.min.js"></script>
